...
cdmltn <- function(sex = "F"){
    ...
    if(sex == "F") { # Female
        ...
        #   the nqx's on e10
        # JO correction age 5
        ax <- c(0.47504, 0.45025, 0.19376, 0.10041, 0.10126, 0.11261, 
                 0.13137, 0.15448, 0.17693, 0.1844, 0.1944, 0.22364, 
                 0.30043, 0.41033, 0.56691, 0.77206, 0.96175)
        ...
        # JO correction age 20
        b1x <- c(-0.05133, -0.08909, -0.08647, -0.07192, -0.05955, 
                  -0.05372, -0.05236, -0.05339, -0.05136, -0.04261, 
                  -0.03627, -0.02961, -0.02858, -0.02511, -0.02152, 
                  -0.01784, -0.01355)
        #####################################################################
    ...
    # JO correction age 60
    bxm <- c(-0.008251, -0.00729, -0.002974, -0.001476, -0.001422, 
             -0.001968, -0.002103, -0.002244, -0.002589, -0.003083, 
             -0.003605, -0.004016, -0.005037, -0.006124, -0.007677, 
             -0.010241, -0.011906)
